...
public class Task1e {
    ...
    public static void numbersTotal(int number) {
        ...
        switch (mathOperations){
            ...
            case '-':
                addNumbers=object.nextInt();
                System.out.println("Difference of "+number+ " and "+addNumbers+" is "+(number-addNumbers));
                break;
            case '/':
                addNumbers=object.nextInt();
                System.out.println("Quotient(kolicnik) of "+number+ " and "+addNumbers+" is "+(number/addNumbers));
                break;
            case '*':
                addNumbers=object.nextInt();
                System.out.println("Product of "+number+ " and "+addNumbers+" is "+(number*addNumbers));
                break;
        }
    }
}
